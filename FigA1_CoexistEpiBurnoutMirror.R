...
cat("R0r:",R0r,"R0i1:",R0i1,"Rptd:",Rptd,"lambdar:",lambdar,"lambdai1:",lambdai1,"u1:",u1,"u2:",u2,"\n")
#cat("betai1:",betai1,"mui1:",mui1,"betai2:",betai2,"mui2",mui2,"\n")
...
if(((gen==10)||(gen==13))||(gen==17)){ #2
  ...
  if(genPoints==1){ pdf("EpiDynBurnoutMirror1.pdf", height = 6, width = 6); 
    cat("genPoints:",genPoints,"\n")
  }
  if(genPoints==2){ 
    pdf("EpiDynBurnoutMirror2.pdf", height = 6, width = 6);
    cat("genPoints:",genPoints,"\n")
  }
  if(genPoints==3){
    cat("genPoints:",genPoints,"\n")
    pdf("EpiDynBurnoutMirror3.pdf", height = 6, width = 6);
  }
  
  plot(out[,1],out[,3],ylim=c(0,0.12),xlim=c(0,60),type="l",axes=FALSE,xlab="",ylab="",lwd=2.25);
...
pdf("LongTermBurnoutMirror.pdf", height = 4, width = 6)
plot(1:LastGen,IrStor,ylim=c(0,1.0),type="l",axes=FALSE,xlab="",ylab="",lwd=2.25)
