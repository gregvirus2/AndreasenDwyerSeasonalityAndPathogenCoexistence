...
if(((gen==1000)||(gen==2000))||(gen==3000)){
  ...
  if(genPoints==1){ pdf("EpiDynTransientMirror1.pdf", height = 6, width = 6); 
    cat("genPoints:",genPoints,"\n")
  }
  if(genPoints==2){ 
    pdf("EpiDynTransientMirror2.pdf", height = 6, width = 6);
    cat("genPoints:",genPoints,"\n")
  }
  if(genPoints==3){
    cat("genPoints:",genPoints,"\n")
    pdf("EpiDynTransientMirror3.pdf", height = 6, width = 6);
  }
...
Ir = Wr*out[Index,5];
Ii = Wi*out[Index,6];
if((gen%%10)==0) cat("gen:",gen,"Ir:",IrStor[gen],"Ii:",IiStor[gen],"\n")
SStart = 1 - Ir - Ii;
...
pdf("LongTermTransientMirror.pdf", height = 4, width = 6)
